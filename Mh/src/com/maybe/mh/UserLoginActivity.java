				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						if (loginStatus.indexOf("username") != -1) {
							...
							JSONObject resObj = JSONObject.parseObject(loginStatus);

							Object jsonUser = resObj.get("user");
							JSONObject userObj = JSONObject.parseObject(jsonUser.toString());
							...
							if(infoStr != null){
								...
								List<DoWork> doWorkList = JSON.parseArray(infoStr.toString(), DoWork.class);
