...
public class DownloadService extends Service {
	...
	// 返回的安装包url
	private String apkUrl = "http://www.gelanghe.gov.cn/app/mh.apk";
	// private String apkUrl = MyApp.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = MyApplication.getMyApplication().getLocalPath();

	private static final String saveFileName = savePath + "/格朗和.apk";
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name, "格朗和.apk 正在下载...");
		// 指定个性化视图
